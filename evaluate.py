...
def calc_metrics(method='HIMEX', dataset='SST-2'):
    ...
    if method in ['HEDGE', 'HIMEX']:
        ...
        coherence.std().to_csv(f'{path}/coherence_std.csv', index=False, header=False)
...
if __name__ == '__main__':
    calc_metrics(method='HIMEX', dataset='SST-2')